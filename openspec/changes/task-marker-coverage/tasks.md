...
- [ ] 3.2 Add the two hard-gate regressions over archive fixtures (unfinished
      non-canonical task; fully non-canonical ledger), each failing before the
      fix, and verify by verification rows 1.1 and 1.2
- [ ] 3.3 Add the strict-validate assertion for a non-canonical task fixture,
      and verify by verification row 3.1
- [ ] 3.4 Run `mise run test` and `mise run test:contract`, and verify by
